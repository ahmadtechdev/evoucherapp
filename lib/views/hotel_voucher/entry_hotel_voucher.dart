...
class HotelBookingForm extends StatelessWidget {
  ...
  Widget _buildTopDateSection(HotelBookingController controller) {
    return Container(
  ...
  Widget _buildCustomerTab(HotelBookingController controller) {
  ...
  Widget _buildSupplierTab(HotelBookingController controller) {
    return SingleChildScrollView(
      padding: const EdgeInsets.all(20),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget _buildCustomerBasicInfo(HotelBookingController controller) {
    return Column(
      children: [
        RoundTitleTextfield(
          title: 'Phone Number',
  ...
  Widget _buildRoomDetails(HotelBookingController controller) {
    return Column(
      children: [
        RoundTitleTextfield(
          title: 'Room Type',
  ...
  Widget _buildGuestCounters(HotelBookingController controller) {
    return Column(
      children: [
        _buildCounterField(
          title: 'Adults',
  ...
  Widget _buildFinancialDetails(HotelBookingController controller) {
    return Column(
      children: [
  ...
  Widget _buildSupplierBasicInfo(HotelBookingController controller) {
    return Column(
      children: [
        RoundTitleTextfield(
  ...
  Widget _buildSupplierFinancials(HotelBookingController controller) {
    return Column(
      children: [
        Obx(() => RoundTitleTextfield(
  ...
  Widget _buildSupplierSummary(HotelBookingController controller) {
    return Column(
      children: [
        Row(
          children: [
  ...
  Widget _buildBottomButton(HotelBookingController controller) {
    return Container(
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
        color: Colors.white,
