...
class DetailsSaleReportController extends GetxController {
  ...
  Future<void> fetchTransactions({
    ...
    try {
      ...
      if (response['status'] == 'success') {
        ...
        grandTotals.value = {
          'total_sales':
              parseAmount(grandTotalData['total_sales'].toString()).toString(),
          'total_purchases':
              parseAmount(grandTotalData['total_purchases'].toString())
                  .toString(),
          'total_profit_loss':
              parseAmount(grandTotalData['total_profit_loss'].toString())
                  .toString(),
        };
