...
import 'package:evoucher/views/home/home_dashboard/all_hotle_sales_report/all_hotle_sale_controller.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import '../../../../common/color_extension.dart';

class HotelSalesReport extends StatefulWidget {
  @override
  State<HotelSalesReport> createState() => _HotelSalesReportState();
}

class _HotelSalesReportState extends State<HotelSalesReport> {
  DateTime toDate = DateTime.now();
  DateTime fromDate = DateTime.now();
  final AllHotleSaleController Controller = Get.put(AllHotleSaleController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Hotel Sales Report'),
      ),
      body: SafeArea(
        child: Column(
          children: [
...
class CollapsibleTransactionCard extends StatelessWidget {
  ...
  final int index;
  final AllHotleSaleController controller;
