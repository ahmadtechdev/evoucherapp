...
import 'package:evoucher_new/common/accounts_dropdown.dart';
...
class OtherEntryVoucher extends StatelessWidget {
  ...
  Widget _buildBody() {
    return SafeArea(
      child: GetBuilder<OtherEntryVoucherController>(
        init: OtherEntryVoucherController(),
  ...
  Widget _buildTopDateSection(OtherEntryVoucherController controller) {
    return Container(
  ...
  Widget _buildCustomerTab(OtherEntryVoucherController controller) {
  ...
  Widget _buildSupplierTab(OtherEntryVoucherController controller) {
    return SingleChildScrollView(
      padding: const EdgeInsets.all(20),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget _buildCustomerBasicInfo(OtherEntryVoucherController controller) {
    return Column(
      children: [
        RoundTitleTextfield(
  ...
  Widget _buildFinancialDetails(OtherEntryVoucherController controller) {
    return Column(
      children: [
        RoundTitleTextfield(
  ...
  Widget _buildSupplierFinancials(OtherEntryVoucherController controller) {
    return Column(
      children: [
        RoundTitleTextfield(
  ...
  Widget _buildSupplierSummary(OtherEntryVoucherController controller) {
    return Column(
      children: [
        Row(
          children: [
  ...
  Widget _buildBottomButton(OtherEntryVoucherController controller) {
    return Container(
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
        color: Colors.white,
