...
import 'view_transport_voucher_controller.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Transport Vouchers'),
      ),
      body: Column(
        children: [
                ...
                return Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'There are no transport vouchers in this date range',
                        style: TextStyle(
                          fontSize: 14,
      ...
      children: [
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              _buildInfoRow(
                  Icons.calendar_today, 'Date', ticket['formatted_date']),
