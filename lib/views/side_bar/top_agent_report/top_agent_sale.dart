...
import 'controller/top_agent_sale_controller.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Top Agent Sale Report'),
      ),
            ...
            children: [
              ...
              Expanded(
                child: Obx(() {
                  ...
                  return ListView(
                    children: [
                      ...controller.filteredActiveAgents
                          .map((customer) => AgentCard(agent: customer)),
                      _buildZeroSalesHeader(),
                      ...controller.filteredZeroSaleAgents
                          .map((customer) => AgentCard(agent: customer)),
                    ],
                  );
                }),
