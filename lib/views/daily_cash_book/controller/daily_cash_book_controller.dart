...
import '../models/daily_cash_book_modal.dart';
...
class DailyCashBookController extends GetxController {
  ...
  void loadDummyData() {
    transactions.addAll([
      Transaction(id: '877', date: DateTime.now(), description: 'Salary Payment', receipt: 5000.00, payment: 0.00, balance: 44901.00),
      Transaction(id: '878', date: DateTime.now(), description: 'Office Supplies', receipt: 0.00, payment: 1500.00, balance: 43401.00),
