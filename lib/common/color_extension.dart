...
class TColor {
  static Color get primary => const Color(0xff0289ee);
  static Color get secondary => const Color(0xff37B45D);
  static Color get third => const Color(0xffE64A19);
  static Color get fourth => const Color(0xffE0A800);
